...
private  
  def material_params
    params.require(:material).permit(:link,:object_type, :object_id, :name,:description,:category_id,:wx_appid,:wxdesc,:wx_tlimg,:pyq_url,:thumb,:wx_url,:share_url, :wx_title, :wx_ln, :advertisement, :advertisement_1,:team_persons,:one_percent,:team_reward,:total_work)
  end
