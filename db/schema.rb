...
ActiveRecord::Schema.define(version: 20150622105545) do
  ...
  add_index "banners", ["material_id", "state"], name: "index_banners_on_material_id_and_state", using: :btree
  ...
  add_index "oauth_access_grants", ["token"], name: "index_oauth_access_grants_on_token", length: {"token"=>191}, using: :btree
  ...
  add_index "oauth_access_tokens", ["refresh_token"], name: "index_oauth_access_tokens_on_refresh_token", length: {"refresh_token"=>191}, using: :btree
  add_index "oauth_access_tokens", ["resource_owner_id"], name: "index_oauth_access_tokens_on_resource_owner_id", using: :btree
  add_index "oauth_access_tokens", ["token"], name: "index_oauth_access_tokens_on_token", length: {"token"=>191}, using: :btree
  ...
  add_index "oauth_applications", ["uid"], name: "index_oauth_applications_on_uid", length: {"uid"=>191}, using: :btree
